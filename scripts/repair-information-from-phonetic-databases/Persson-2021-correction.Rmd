...
#Looking at the repaired male talker vowels, there were clearly several had tokens by talker SW_032 that haven't been targeted by the outlier detection approach. Also, there were many instances of errors for the back vowels at vowel midpoint, hence, write a new repair file that includes all had by talker SW_032, together with all håd and hod with F2 > 1200
# write.csv(
#   d.vowels.swe.male %>%
#     # Mutate back to arpabet for csv readability
#     mutate(Vowel = factor(
...
#         levels.vowel.SweFA),
#       levels = levels.vowel.SweFA)) %>%
#     filter(Talker == "SW_032" & Vowel == "aa1" | Word %in% c("håd", "hod") & F2 > 1200) %>%
