...
d.vowels.swe.male <- read.csv('../../data/phonetic vowel statistics/Published databases/Persson-2021/raw-formant-data/vowel_formants_swe_summary_native_male.txt', sep = "\t", fileEncoding = "UTF-16BE") %>%
  rbind(read.csv('../../data/phonetic vowel statistics/Published databases/Persson-2021/raw-formant-data/vowel_formants_swe_summary_SW042.txt', sep = "\t", fileEncoding = "UTF-16BE")) %>%
  mutate(
    Trial = as.numeric(gsub("^.*\\_([0-9]+)$", "\\1", Token)),
    F0.mean = ifelse(F0.mean == "--undefined--", NA, as.numeric(F0.mean)),
    Vowel = factor(
...
#       levels = levels.vowel.SweFA),
#       cumulative_probability = as.numeric(cumulative_probability)),
#     file = "../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_male_allCuesvowels_to_repair.csv", row.names = FALSE, quote = FALSE)
...
d.vowels.repaired.male <- 
  read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_male_allCuesvowels_repaired.csv') %>%
...
#     filter(F0_half == TRUE | F0_double == TRUE | is.na(F0)) %>%
#     select(Talker, Vowel, Token, Trial, Location, Quantity, F1, F2, F0),
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_male_F0_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
d.vowels.swe.male %<>%
  ...
  # add the corrected F0s
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_male_F0_repaired.csv') %>%
...
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_male_backvowels_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
#     select(Talker, Vowel, Token, Trial, Location, Quantity, F1, F2, F3),
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_female_backvowels_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
d.vowels.swe.male %>%
  ...
  # add the corrected F1, F2
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_male_backvowels_repaired.csv') %>%
...
d.vowels.swe %<>%
  ...
  # add the corrected F1, F2
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2021/corrected-vowel-data/Persson_2021_L1_female_backvowels_repaired.csv') %>%
      select(Talker, Vowel, Token, Trial, Location, F1, F2, F3, Quantity) %>%
      mutate(
        Location = gsub("\\_", "", Location),
        Vowel = factor(
