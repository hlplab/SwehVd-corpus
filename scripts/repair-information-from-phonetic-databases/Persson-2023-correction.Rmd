...
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_vowels_to_repair.csv",
...
d.vowels.repair %<>%
  anti_join(read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_vowels_repaired.csv') %>%
...
d.vowels.repair %<>% 
  anti_join(read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_F0_repaired.csv') %>%
...
#     file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_allCuesvowels_to_repair.csv", row.names = FALSE, quote = FALSE)
...
#       levels = levels.vowel.SweFA),
#       cumulative_probability = as.numeric(cumulative_probability)),
#     file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_male_allCuesvowels_to_repair.csv", row.names = FALSE, quote = FALSE)
...
d.vowels.swe %<>%
  ...
  left_join(
  read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_allCuesvowels_repairedF0Dur.csv') %>%
...
d.vowels.swe %<>%
  ...
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_vowels_repaired.csv') %>%
      select(Talker, Vowel, Token, Trial, Location, F1, F2, Quantity) %>%
      mutate(
        Location = gsub("\\_", "", Location),
        Vowel = factor(
...
d.vowels.repaired.male <- 
  read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_male_allCuesvowels_repaired.csv') %>%
...
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_F0_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
d.vowels.swe %<>%
  ...
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_F0_repaired.csv') %>%
...
#       levels = levels.vowel.SweFA),
#       cumulative_probability = as.numeric(cumulative_probability)),
#     file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_F0_to_repair_no2.csv", row.names = FALSE, quote = FALSE)
...
d.vowels.swe %<>%
  ...
  left_join(
  read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_F0_no2_repaired.csv') %>%
      select(Talker, Vowel, Token, Trial, Location, Quantity, F0, Duration, outlier_source) %>%
      mutate(
        Location = gsub("\\_", "", Location),
        Vowel = factor(
...
#       levels = levels.vowel.SweFA),
#       cumulative_probability = as.numeric(cumulative_probability)),
#     file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_F0_to_repair_no3.csv", row.names = FALSE, quote = FALSE)
```
...
d.vowels.swe %<>%
  select(Talker, Age, Gender, Vowel, Transcribed_vowel, Word, Token, Trial, Location, F1, F2, F3, F0_gm, F0, Duration, SR, Quantity, Unreliable_measurement) %>%
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_F0_no3_repaired.csv') %>%
...
#     select(Talker, Vowel, Token, Trial, Location, Quantity, F1, F2, F0),
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_male_F0_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
d.vowels.swe.male %<>%
  ...
  # add the corrected F0s
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_male_F0_repaired.csv') %>%
...
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_male_backvowels_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
#     select(Talker, Vowel, Token, Trial, Location, Quantity, F1, F2, F3),
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_female_backvowels_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
d.vowels.swe.male %<>%
  ...
  # add the corrected F1, F2
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_male_backvowels_repaired.csv') %>%
...
d.vowels.swe %<>%
  ...
  # add the corrected F1, F2
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_female_backvowels_repaired.csv') %>%
      select(Talker, Vowel, Token, Trial, Location, F1, F2, F3, Quantity) %>%
      mutate(
        Location = gsub("\\_", "", Location),
        Vowel = factor(
...
#     select(Talker, Vowel, Token, Trial, Location, Quantity, F1, F2, F3),
#   file = "../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_SW048_backvowels_to_repair.csv",
#   row.names = FALSE, quote = FALSE)
...
d.vowels.swe.male %<>%
  ...
  # add the corrected F1, F2
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_SW048_backvowels_repaired.csv') %>%
      select(Talker, Vowel, Token, Trial, Location, F1, F2, F3, Quantity) %>%
      mutate(
        Location = gsub("\\_", "", Location),
        Vowel = factor(
...
d.vowels.swe %<>%
  ...
  # add the corrected F1, F2
  left_join(
    read_csv('../../data/phonetic vowel statistics/Published databases/Persson-2023/corrected-vowel-data/Persson_2023_L1_repaired_F3.csv') %>%
